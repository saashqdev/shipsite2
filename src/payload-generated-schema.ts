...
export const enum_pages_blocks_accordion_size = pgEnum('enum_pages_blocks_accordion_size', [
  'full',
  'half',
  'oneThird',
])
...
export const enum_pages_blocks_zigzag_content_links_link_type = pgEnum(
  'enum_pages_blocks_zigzag_content_links_link_type',
  ['reference', 'custom'],
)
export const enum_pages_blocks_zigzag_content_links_link_appearance = pgEnum(
  'enum_pages_blocks_zigzag_content_links_link_appearance',
  ['default', 'outline'],
)
...
export const enum__pages_v_blocks_accordion_size = pgEnum('enum__pages_v_blocks_accordion_size', [
  'full',
  'half',
  'oneThird',
])
...
export const enum__pages_v_blocks_zigzag_content_links_link_type = pgEnum(
  'enum__pages_v_blocks_zigzag_content_links_link_type',
  ['reference', 'custom'],
)
export const enum__pages_v_blocks_zigzag_content_links_link_appearance = pgEnum(
  'enum__pages_v_blocks_zigzag_content_links_link_appearance',
  ['default', 'outline'],
)
...
export const enum_admins_roles = pgEnum('enum_admins_roles', ['super-admin', 'admin'])
...
export const enum_forms_form_style = pgEnum('enum_forms_form_style', [
  'newsletter',
  'contact',
  'none',
])
...
export const enum_header_call_to_action_link_type = pgEnum('enum_header_call_to_action_link_type', [
  'reference',
  'custom',
])
export const enum_footer_nav_sections_nav_items_link_type = pgEnum(
  'enum_footer_nav_sections_nav_items_link_type',
  ['reference', 'custom'],
)

export const pages_hero_slider_images = pgTable(
  'pages_hero_slider_images',
  {
  ...
  (columns) => ({
    _orderIdx: index('pages_hero_slider_images_order_idx').on(columns._order),
    _parentIDIdx: index('pages_hero_slider_images_parent_id_idx').on(columns._parentID),
    pages_hero_slider_images_image_idx: index('pages_hero_slider_images_image_idx').on(
      columns.image,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_hero_slider_images_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const pages_blocks_cta = pgTable(
  'pages_blocks_cta',
  {
    ...
    useBackgroundImage: boolean('use_background_image'),
  ...
  (columns) => ({
    ...
    pages_blocks_cta_bg_image_idx: index('pages_blocks_cta_bg_image_idx').on(columns.bgImage),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
...
export const pages_blocks_form_block = pgTable(
  'pages_blocks_form_block',
  {
    ...
    introContent: jsonb('intro_content'),
    secondaryContent: boolean('secondary_content'),
    secondaryContentText: jsonb('secondary_content_text'),
    blockName: varchar('block_name'),
  },
  (columns) => ({
...
export const pages_blocks_accordion = pgTable(
  'pages_blocks_accordion',
  {
    ...
    size: enum_pages_blocks_accordion_size('size').default('full'),
    blockName: varchar('block_name'),
  },
  (columns) => ({
...
export const pages_blocks_pricing_plans = pgTable(
  ...
  (columns) => ({
    _orderIdx: index('pages_blocks_pricing_plans_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_pricing_plans_parent_id_idx').on(columns._parentID),
    pages_blocks_pricing_plans_product_idx: index('pages_blocks_pricing_plans_product_idx').on(
      columns.product,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
...
export const pages_blocks_pricing = pgTable(
  ...
  (columns) => ({
    _orderIdx: index('pages_blocks_pricing_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_pricing_parent_id_idx').on(columns._parentID),
    _pathIdx: index('pages_blocks_pricing_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
...
export const pages_blocks_cloud_logos_company_logos = pgTable(
  'pages_blocks_cloud_logos_company_logos',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('pages_blocks_cloud_logos_company_logos_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_cloud_logos_company_logos_parent_id_idx').on(
      columns._parentID,
    ),
    pages_blocks_cloud_logos_company_logos_image_idx: index(
      'pages_blocks_cloud_logos_company_logos_image_idx',
    ).on(columns.image),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_cloud_logos.id],
      name: 'pages_blocks_cloud_logos_company_logos_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_cloud_logos = pgTable(
  'pages_blocks_cloud_logos',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    id: varchar('id').primaryKey(),
    grayscale: boolean('grayscale').default(false),
    blockName: varchar('block_name'),
  },
  (columns) => ({
    _orderIdx: index('pages_blocks_cloud_logos_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_cloud_logos_parent_id_idx').on(columns._parentID),
    _pathIdx: index('pages_blocks_cloud_logos_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_cloud_logos_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const pages_blocks_features = pgTable(
  'pages_blocks_features',
  {
    ...
    _path: text('_path').notNull(),
    id: varchar('id').primaryKey(),
    layout: enum_pages_blocks_features_layout('layout').default('standard'),
    header: varchar('header'),
    title: varchar('title'),
    description: varchar('description'),
    image: integer('image_id').references(() => media.id, {
  ...
  (columns) => ({
    ...
    pages_blocks_features_image_idx: index('pages_blocks_features_image_idx').on(columns.image),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
...
export const pages_blocks_zigzag_content_links = pgTable(
  'pages_blocks_zigzag_content_links',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    link_type: enum_pages_blocks_zigzag_content_links_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    link_label: varchar('link_label'),
    link_appearance:
      enum_pages_blocks_zigzag_content_links_link_appearance('link_appearance').default('default'),
  },
  (columns) => ({
    _orderIdx: index('pages_blocks_zigzag_content_links_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_zigzag_content_links_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_zigzag_content.id],
      name: 'pages_blocks_zigzag_content_links_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_zigzag_content = pgTable(
  'pages_blocks_zigzag_content',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('pages_blocks_zigzag_content_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_zigzag_content_parent_id_idx').on(columns._parentID),
    pages_blocks_zigzag_content_image_idx: index('pages_blocks_zigzag_content_image_idx').on(
      columns.image,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_zigzag.id],
      name: 'pages_blocks_zigzag_content_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_zigzag = pgTable(
  'pages_blocks_zigzag',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('pages_blocks_zigzag_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_zigzag_parent_id_idx').on(columns._parentID),
    _pathIdx: index('pages_blocks_zigzag_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_zigzag_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_testimonial_reviews = pgTable(
  'pages_blocks_testimonial_reviews',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('pages_blocks_testimonial_reviews_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_testimonial_reviews_parent_id_idx').on(columns._parentID),
    pages_blocks_testimonial_reviews_image_idx: index(
      'pages_blocks_testimonial_reviews_image_idx',
    ).on(columns.image),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_testimonial.id],
      name: 'pages_blocks_testimonial_reviews_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const pages_blocks_testimonial = pgTable(
  ...
  (columns) => ({
    ...
    _parentIDIdx: index('pages_blocks_testimonial_parent_id_idx').on(columns._parentID),
...
export const pages_blocks_team_team_members = pgTable(
  'pages_blocks_team_team_members',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('pages_blocks_team_team_members_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_team_team_members_parent_id_idx').on(columns._parentID),
    pages_blocks_team_team_members_image_idx: index('pages_blocks_team_team_members_image_idx').on(
      columns.image,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_team.id],
      name: 'pages_blocks_team_team_members_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const pages = pgTable(
  'pages',
  {
    ...
    title: varchar('title'),
    hero_type: enum_pages_hero_type('hero_type').default('none'),
    hero_heroImage: integer('hero_hero_image_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    hero_media: integer('hero_media_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    hero_slider: boolean('hero_slider'),
    hero_backgroundImage: integer('hero_background_image_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    hero_richText: jsonb('hero_rich_text'),
    hero_showTopText: boolean('hero_show_top_text'),
    hero_topText: varchar('hero_top_text'),
  ...
  (columns) => ({
    pages_hero_hero_hero_image_idx: index('pages_hero_hero_hero_image_idx').on(
      columns.hero_heroImage,
    ),
    pages_hero_hero_media_idx: index('pages_hero_hero_media_idx').on(columns.hero_media),
    pages_hero_hero_background_image_idx: index('pages_hero_hero_background_image_idx').on(
...
export const _pages_v_version_hero_slider_images = pgTable(
  '_pages_v_version_hero_slider_images',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_version_hero_slider_images_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_version_hero_slider_images_parent_id_idx').on(columns._parentID),
    _pages_v_version_hero_slider_images_image_idx: index(
      '_pages_v_version_hero_slider_images_image_idx',
    ).on(columns.image),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_version_hero_slider_images_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const _pages_v_blocks_cta = pgTable(
  ...
  (columns) => ({
    ...
    _pages_v_blocks_cta_bg_image_idx: index('_pages_v_blocks_cta_bg_image_idx').on(columns.bgImage),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
...
export const _pages_v_blocks_accordion = pgTable(
  '_pages_v_blocks_accordion',
  {
    ...
    title: varchar('title'),
    description: varchar('description'),
    size: enum__pages_v_blocks_accordion_size('size').default('full'),
    _uuid: varchar('_uuid'),
    blockName: varchar('block_name'),
  },
  (columns) => ({
...
export const _pages_v_blocks_pricing_plans = pgTable(
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_pricing_plans_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_pricing_plans_parent_id_idx').on(columns._parentID),
    _pages_v_blocks_pricing_plans_product_idx: index(
      '_pages_v_blocks_pricing_plans_product_idx',
    ).on(columns.product),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
...
export const _pages_v_blocks_pricing = pgTable(
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_pricing_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_pricing_parent_id_idx').on(columns._parentID),
    _pathIdx: index('_pages_v_blocks_pricing_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
...
export const _pages_v_blocks_cloud_logos_company_logos = pgTable(
  '_pages_v_blocks_cloud_logos_company_logos',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_cloud_logos_company_logos_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_cloud_logos_company_logos_parent_id_idx').on(
      columns._parentID,
    ),
    _pages_v_blocks_cloud_logos_company_logos_image_idx: index(
      '_pages_v_blocks_cloud_logos_company_logos_image_idx',
    ).on(columns.image),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_cloud_logos.id],
      name: '_pages_v_blocks_cloud_logos_company_logos_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_cloud_logos = pgTable(
  '_pages_v_blocks_cloud_logos',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_cloud_logos_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_cloud_logos_parent_id_idx').on(columns._parentID),
    _pathIdx: index('_pages_v_blocks_cloud_logos_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_cloud_logos_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const _pages_v_blocks_features = pgTable(
  '_pages_v_blocks_features',
  {
    ...
    _path: text('_path').notNull(),
    id: serial('id').primaryKey(),
    layout: enum__pages_v_blocks_features_layout('layout').default('standard'),
    header: varchar('header'),
    title: varchar('title'),
    description: varchar('description'),
    image: integer('image_id').references(() => media.id, {
  ...
  (columns) => ({
    ...
    _pages_v_blocks_features_image_idx: index('_pages_v_blocks_features_image_idx').on(
      columns.image,
    ),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
...
export const _pages_v_blocks_zigzag_content_links = pgTable(
  '_pages_v_blocks_zigzag_content_links',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
    link_type:
      enum__pages_v_blocks_zigzag_content_links_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    link_label: varchar('link_label'),
    link_appearance:
      enum__pages_v_blocks_zigzag_content_links_link_appearance('link_appearance').default(
        'default',
      ),
    _uuid: varchar('_uuid'),
  },
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_zigzag_content_links_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_zigzag_content_links_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_zigzag_content.id],
      name: '_pages_v_blocks_zigzag_content_links_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_zigzag_content = pgTable(
  '_pages_v_blocks_zigzag_content',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_zigzag_content_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_zigzag_content_parent_id_idx').on(columns._parentID),
    _pages_v_blocks_zigzag_content_image_idx: index('_pages_v_blocks_zigzag_content_image_idx').on(
      columns.image,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_zigzag.id],
      name: '_pages_v_blocks_zigzag_content_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_zigzag = pgTable(
  '_pages_v_blocks_zigzag',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_zigzag_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_zigzag_parent_id_idx').on(columns._parentID),
    _pathIdx: index('_pages_v_blocks_zigzag_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_zigzag_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_testimonial_reviews = pgTable(
  '_pages_v_blocks_testimonial_reviews',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_testimonial_reviews_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_testimonial_reviews_parent_id_idx').on(columns._parentID),
    _pages_v_blocks_testimonial_reviews_image_idx: index(
      '_pages_v_blocks_testimonial_reviews_image_idx',
    ).on(columns.image),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_testimonial.id],
      name: '_pages_v_blocks_testimonial_reviews_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const _pages_v_blocks_testimonial = pgTable(
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_testimonial_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_testimonial_parent_id_idx').on(columns._parentID),
...
export const _pages_v_blocks_team_team_members = pgTable(
  '_pages_v_blocks_team_team_members',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_team_team_members_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_team_team_members_parent_id_idx').on(columns._parentID),
    _pages_v_blocks_team_team_members_image_idx: index(
      '_pages_v_blocks_team_team_members_image_idx',
    ).on(columns.image),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_team.id],
      name: '_pages_v_blocks_team_team_members_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const _pages_v = pgTable(
  '_pages_v',
  {
    ...
    version_hero_type: enum__pages_v_version_hero_type('version_hero_type').default('none'),
    version_hero_heroImage: integer('version_hero_hero_image_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    version_hero_media: integer('version_hero_media_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    version_hero_slider: boolean('version_hero_slider'),
    ...
    version_hero_showTopText: boolean('version_hero_show_top_text'),
    version_hero_topText: varchar('version_hero_top_text'),
  ...
  (columns) => ({
    ...
    _pages_v_version_hero_version_hero_hero_image_idx: index(
      '_pages_v_version_hero_version_hero_hero_image_idx',
    ).on(columns.version_hero_heroImage),
    ...
    _pages_v_version_hero_version_hero_background_image_idx: index(
      '_pages_v_version_hero_version_hero_background_image_idx',
    ).on(columns.version_hero_backgroundImage),
...
export const posts_rels = pgTable(
  ...
  (columns) => ({
    ...
    posts_rels_admins_id_idx: index('posts_rels_admins_id_idx').on(columns.adminsID),
    parentFk: foreignKey({
      columns: [columns['parent']],
      foreignColumns: [posts.id],
...
export const _posts_v_rels = pgTable(
  ...
  (columns) => ({
    ...
    _posts_v_rels_admins_id_idx: index('_posts_v_rels_admins_id_idx').on(columns.adminsID),
    parentFk: foreignKey({
      columns: [columns['parent']],
      foreignColumns: [_posts_v.id],
...
export const user = pgTable(
  'user',
  {
    ...
    renewalDate: timestamp('renewal_date', { mode: 'string', withTimezone: true, precision: 3 }),
  ...
  (columns) => ({
    user_profile_image_idx: index('user_profile_image_idx').on(columns.profileImage),
...
export const admins_roles = pgTable(
  'admins_roles',
  {
    order: integer('order').notNull(),
    parent: integer('parent_id').notNull(),
    value: enum_admins_roles('value'),
    id: serial('id').primaryKey(),
  },
  (columns) => ({
    orderIdx: index('admins_roles_order_idx').on(columns.order),
    parentIdx: index('admins_roles_parent_idx').on(columns.parent),
    parentFk: foreignKey({
      columns: [columns['parent']],
      foreignColumns: [admins.id],
      name: 'admins_roles_parent_fk',
    }).onDelete('cascade'),
  }),
)
...
export const products_prices = pgTable(
  'products_prices',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('products_prices_order_idx').on(columns._order),
    _parentIDIdx: index('products_prices_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [products.id],
      name: 'products_prices_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const products = pgTable(
  ...
  {
    id: serial('id').primaryKey(),
    stripeProductID: varchar('stripe_product_i_d').notNull(),
    name: varchar('name'),
    description: varchar('description'),
  ...
  (columns) => ({
    products_stripe_product_i_d_idx: uniqueIndex('products_stripe_product_i_d_idx').on(
...
export const forms = pgTable(
  'forms',
  {
    ...
    formStyle: enum_forms_form_style('form_style').notNull().default('none'),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
      .notNull(),
    createdAt: timestamp('created_at', { mode: 'string', withTimezone: true, precision: 3 })
...
export const header = pgTable(
  ...
  {
    id: serial('id').primaryKey(),
    showCTA: boolean('show_c_t_a'),
    CallToAction_link_type: enum_header_call_to_action_link_type(
      'call_to_action_link_type',
    ).default('reference'),
    CallToAction_link_newTab: boolean('call_to_action_link_new_tab'),
    CallToAction_link_url: varchar('call_to_action_link_url'),
    CallToAction_link_label: varchar('call_to_action_link_label'),
    Styles_media: integer('styles_media_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 }),
    createdAt: timestamp('created_at', { mode: 'string', withTimezone: true, precision: 3 }),
  ...
  (columns) => ({
    header_styles_styles_media_idx: index('header_styles_styles_media_idx').on(
      columns.Styles_media,
    ),
  }),
)
...
export const footer_nav_sections_nav_items = pgTable(
  'footer_nav_sections_nav_items',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    link_type: enum_footer_nav_sections_nav_items_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    link_label: varchar('link_label').notNull(),
  },
  (columns) => ({
    _orderIdx: index('footer_nav_sections_nav_items_order_idx').on(columns._order),
    _parentIDIdx: index('footer_nav_sections_nav_items_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [footer_nav_sections.id],
      name: 'footer_nav_sections_nav_items_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const footer_nav_sections = pgTable(
  'footer_nav_sections',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
  ...
  (columns) => ({
    _orderIdx: index('footer_nav_sections_order_idx').on(columns._order),
    _parentIDIdx: index('footer_nav_sections_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [footer.id],
      name: 'footer_nav_sections_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const footer = pgTable(
  'footer',
  {
    ...
    useBottomText: boolean('use_bottom_text').default(false),
...
export const relations_pages_hero_slider_images = relations(
  pages_hero_slider_images,
  ({ one }) => ({
    _parentID: one(pages, {
      fields: [pages_hero_slider_images._parentID],
      references: [pages.id],
      relationName: 'hero_sliderImages',
    }),
    image: one(media, {
      fields: [pages_hero_slider_images.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
...
export const relations_pages_blocks_cta = relations(pages_blocks_cta, ({ one, many }) => ({
  ...
  bgImage: one(media, {
    fields: [pages_blocks_cta.bgImage],
    references: [media.id],
...
export const relations_pages_blocks_pricing_plans = relations(
  ...
  ({ one }) => ({
    ...
    product: one(products, {
      fields: [pages_blocks_pricing_plans.product],
...
export const relations_pages_blocks_cloud_logos_company_logos = relations(
  pages_blocks_cloud_logos_company_logos,
  ({ one }) => ({
    _parentID: one(pages_blocks_cloud_logos, {
      fields: [pages_blocks_cloud_logos_company_logos._parentID],
      references: [pages_blocks_cloud_logos.id],
      relationName: 'companyLogos',
    }),
    image: one(media, {
      fields: [pages_blocks_cloud_logos_company_logos.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
)
export const relations_pages_blocks_cloud_logos = relations(
  pages_blocks_cloud_logos,
  ({ one, many }) => ({
    _parentID: one(pages, {
      fields: [pages_blocks_cloud_logos._parentID],
      references: [pages.id],
      relationName: '_blocks_cloudLogos',
    }),
    companyLogos: many(pages_blocks_cloud_logos_company_logos, {
      relationName: 'companyLogos',
    }),
  }),
)
...
export const relations_pages_blocks_features = relations(
  ...
  ({ one, many }) => ({
    ...
    image: one(media, {
      fields: [pages_blocks_features.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
)
export const relations_pages_blocks_zigzag_content_links = relations(
  pages_blocks_zigzag_content_links,
  ({ one }) => ({
    _parentID: one(pages_blocks_zigzag_content, {
      fields: [pages_blocks_zigzag_content_links._parentID],
      references: [pages_blocks_zigzag_content.id],
      relationName: 'links',
    }),
  }),
)
export const relations_pages_blocks_zigzag_content = relations(
  pages_blocks_zigzag_content,
  ({ one, many }) => ({
    _parentID: one(pages_blocks_zigzag, {
      fields: [pages_blocks_zigzag_content._parentID],
      references: [pages_blocks_zigzag.id],
      relationName: 'content',
    }),
    image: one(media, {
      fields: [pages_blocks_zigzag_content.image],
      references: [media.id],
      relationName: 'image',
    }),
    links: many(pages_blocks_zigzag_content_links, {
      relationName: 'links',
    }),
  }),
)
export const relations_pages_blocks_zigzag = relations(pages_blocks_zigzag, ({ one, many }) => ({
  _parentID: one(pages, {
    fields: [pages_blocks_zigzag._parentID],
    references: [pages.id],
    relationName: '_blocks_zigzag',
  }),
  content: many(pages_blocks_zigzag_content, {
    relationName: 'content',
  }),
}))
export const relations_pages_blocks_testimonial_reviews = relations(
  pages_blocks_testimonial_reviews,
  ({ one }) => ({
    _parentID: one(pages_blocks_testimonial, {
      fields: [pages_blocks_testimonial_reviews._parentID],
      references: [pages_blocks_testimonial.id],
      relationName: 'reviews',
    }),
    image: one(media, {
      fields: [pages_blocks_testimonial_reviews.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
...
export const relations_pages_blocks_testimonial = relations(
  ...
  ({ one, many }) => ({
    ...
    reviews: many(pages_blocks_testimonial_reviews, {
      relationName: 'reviews',
    }),
  }),
)
export const relations_pages_blocks_team_team_members = relations(
  pages_blocks_team_team_members,
  ({ one }) => ({
    _parentID: one(pages_blocks_team, {
      fields: [pages_blocks_team_team_members._parentID],
      references: [pages_blocks_team.id],
      relationName: 'teamMembers',
    }),
    image: one(media, {
      fields: [pages_blocks_team_team_members.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
...
export const relations_pages_blocks_team = relations(pages_blocks_team, ({ one, many }) => ({
  ...
  teamMembers: many(pages_blocks_team_team_members, {
    relationName: 'teamMembers',
  }),
}))
...
export const relations_pages = relations(pages, ({ one, many }) => ({
  ...
  hero_sliderImages: many(pages_hero_slider_images, {
    relationName: 'hero_sliderImages',
  }),
  ...
  _blocks_cloudLogos: many(pages_blocks_cloud_logos, {
    relationName: '_blocks_cloudLogos',
  }),
  _blocks_features: many(pages_blocks_features, {
    relationName: '_blocks_features',
  }),
  _blocks_zigzag: many(pages_blocks_zigzag, {
    relationName: '_blocks_zigzag',
  }),
...
export const relations__pages_v_version_hero_slider_images = relations(
  _pages_v_version_hero_slider_images,
  ({ one }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_version_hero_slider_images._parentID],
      references: [_pages_v.id],
      relationName: 'version_hero_sliderImages',
    }),
    image: one(media, {
      fields: [_pages_v_version_hero_slider_images.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
...
export const relations__pages_v_blocks_cta = relations(_pages_v_blocks_cta, ({ one, many }) => ({
  ...
  bgImage: one(media, {
    fields: [_pages_v_blocks_cta.bgImage],
    references: [media.id],
    relationName: 'bgImage',
  }),
}))
...
export const relations__pages_v_blocks_pricing_plans = relations(
  ...
  ({ one }) => ({
    ...
    product: one(products, {
      fields: [_pages_v_blocks_pricing_plans.product],
      references: [products.id],
      relationName: 'product',
    }),
  }),
...
export const relations__pages_v_blocks_cloud_logos_company_logos = relations(
  _pages_v_blocks_cloud_logos_company_logos,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_cloud_logos, {
      fields: [_pages_v_blocks_cloud_logos_company_logos._parentID],
      references: [_pages_v_blocks_cloud_logos.id],
      relationName: 'companyLogos',
    }),
    image: one(media, {
      fields: [_pages_v_blocks_cloud_logos_company_logos.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
)
export const relations__pages_v_blocks_cloud_logos = relations(
  _pages_v_blocks_cloud_logos,
  ({ one, many }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_cloud_logos._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_cloudLogos',
    }),
    companyLogos: many(_pages_v_blocks_cloud_logos_company_logos, {
      relationName: 'companyLogos',
    }),
  }),
)
...
export const relations__pages_v_blocks_features = relations(
  ...
  ({ one, many }) => ({
    ...
    image: one(media, {
      fields: [_pages_v_blocks_features.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
)
export const relations__pages_v_blocks_zigzag_content_links = relations(
  _pages_v_blocks_zigzag_content_links,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_zigzag_content, {
      fields: [_pages_v_blocks_zigzag_content_links._parentID],
      references: [_pages_v_blocks_zigzag_content.id],
      relationName: 'links',
    }),
  }),
)
export const relations__pages_v_blocks_zigzag_content = relations(
  _pages_v_blocks_zigzag_content,
  ({ one, many }) => ({
    _parentID: one(_pages_v_blocks_zigzag, {
      fields: [_pages_v_blocks_zigzag_content._parentID],
      references: [_pages_v_blocks_zigzag.id],
      relationName: 'content',
    }),
    image: one(media, {
      fields: [_pages_v_blocks_zigzag_content.image],
      references: [media.id],
      relationName: 'image',
    }),
    links: many(_pages_v_blocks_zigzag_content_links, {
      relationName: 'links',
    }),
  }),
)
export const relations__pages_v_blocks_zigzag = relations(
  _pages_v_blocks_zigzag,
  ({ one, many }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_zigzag._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_zigzag',
    }),
    content: many(_pages_v_blocks_zigzag_content, {
      relationName: 'content',
    }),
  }),
)
export const relations__pages_v_blocks_testimonial_reviews = relations(
  _pages_v_blocks_testimonial_reviews,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_testimonial, {
      fields: [_pages_v_blocks_testimonial_reviews._parentID],
      references: [_pages_v_blocks_testimonial.id],
      relationName: 'reviews',
    }),
    image: one(media, {
      fields: [_pages_v_blocks_testimonial_reviews.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
...
export const relations__pages_v_blocks_testimonial = relations(
  ...
  ({ one, many }) => ({
    ...
    reviews: many(_pages_v_blocks_testimonial_reviews, {
      relationName: 'reviews',
    }),
  }),
)
export const relations__pages_v_blocks_team_team_members = relations(
  _pages_v_blocks_team_team_members,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_team, {
      fields: [_pages_v_blocks_team_team_members._parentID],
      references: [_pages_v_blocks_team.id],
      relationName: 'teamMembers',
    }),
    image: one(media, {
      fields: [_pages_v_blocks_team_team_members.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
...
export const relations__pages_v_blocks_team = relations(_pages_v_blocks_team, ({ one, many }) => ({
  ...
  teamMembers: many(_pages_v_blocks_team_team_members, {
    relationName: 'teamMembers',
  }),
}))
...
export const relations__pages_v = relations(_pages_v, ({ one, many }) => ({
  ...
  version_hero_heroImage: one(media, {
    fields: [_pages_v.version_hero_heroImage],
    references: [media.id],
    relationName: 'version_hero_heroImage',
  }),
  ...
  version_hero_sliderImages: many(_pages_v_version_hero_slider_images, {
    relationName: 'version_hero_sliderImages',
  }),
  ...
  _blocks_cloudLogos: many(_pages_v_blocks_cloud_logos, {
    relationName: '_blocks_cloudLogos',
  }),
  _blocks_features: many(_pages_v_blocks_features, {
    relationName: '_blocks_features',
  }),
  _blocks_zigzag: many(_pages_v_blocks_zigzag, {
    relationName: '_blocks_zigzag',
  }),
...
export const relations_user = relations(user, ({ one }) => ({
...
export const relations_admins_roles = relations(admins_roles, ({ one }) => ({
  parent: one(admins, {
    fields: [admins_roles.parent],
    references: [admins.id],
    relationName: 'roles',
  }),
}))
...
export const relations_products_prices = relations(products_prices, ({ one }) => ({
  _parentID: one(products, {
    fields: [products_prices._parentID],
    references: [products.id],
    relationName: 'prices',
  }),
}))
...
export const relations_header = relations(header, ({ one, many }) => ({
  ...
  Styles_media: one(media, {
    fields: [header.Styles_media],
    references: [media.id],
    relationName: 'Styles_media',
  }),
  _rels: many(header_rels, {
    relationName: '_rels',
  }),
}))
export const relations_footer_nav_sections_nav_items = relations(
  footer_nav_sections_nav_items,
  ({ one }) => ({
    _parentID: one(footer_nav_sections, {
      fields: [footer_nav_sections_nav_items._parentID],
      references: [footer_nav_sections.id],
      relationName: 'navItems',
    }),
  }),
)
export const relations_footer_nav_sections = relations(footer_nav_sections, ({ one, many }) => ({
  _parentID: one(footer, {
    fields: [footer_nav_sections._parentID],
    references: [footer.id],
    relationName: 'navSections',
  }),
  navItems: many(footer_nav_sections_nav_items, {
    relationName: 'navItems',
  }),
}))
...
export const relations_footer = relations(footer, ({ one, many }) => ({
  ...
  navSections: many(footer_nav_sections, {
    relationName: 'navSections',
  }),
...
type DatabaseSchema = {
  ...
  enum_pages_blocks_accordion_size: typeof enum_pages_blocks_accordion_size
  enum_pages_blocks_features_layout: typeof enum_pages_blocks_features_layout
  enum_pages_blocks_zigzag_content_links_link_type: typeof enum_pages_blocks_zigzag_content_links_link_type
  enum_pages_blocks_zigzag_content_links_link_appearance: typeof enum_pages_blocks_zigzag_content_links_link_appearance
  ...
  enum__pages_v_blocks_accordion_size: typeof enum__pages_v_blocks_accordion_size
  enum__pages_v_blocks_features_layout: typeof enum__pages_v_blocks_features_layout
  enum__pages_v_blocks_zigzag_content_links_link_type: typeof enum__pages_v_blocks_zigzag_content_links_link_type
  enum__pages_v_blocks_zigzag_content_links_link_appearance: typeof enum__pages_v_blocks_zigzag_content_links_link_appearance
  enum__pages_v_version_hero_type: typeof enum__pages_v_version_hero_type
  enum__pages_v_version_status: typeof enum__pages_v_version_status
  enum_posts_status: typeof enum_posts_status
  enum__posts_v_version_status: typeof enum__posts_v_version_status
  enum_admins_roles: typeof enum_admins_roles
  enum_redirects_to_type: typeof enum_redirects_to_type
  enum_forms_confirmation_type: typeof enum_forms_confirmation_type
  enum_forms_form_style: typeof enum_forms_form_style
  enum_payload_jobs_log_task_slug: typeof enum_payload_jobs_log_task_slug
  enum_payload_jobs_log_state: typeof enum_payload_jobs_log_state
  enum_payload_jobs_task_slug: typeof enum_payload_jobs_task_slug
  enum_header_nav_items_link_type: typeof enum_header_nav_items_link_type
  enum_header_call_to_action_link_type: typeof enum_header_call_to_action_link_type
  enum_footer_nav_sections_nav_items_link_type: typeof enum_footer_nav_sections_nav_items_link_type
  pages_hero_slider_images: typeof pages_hero_slider_images
  ...
  pages_blocks_cloud_logos_company_logos: typeof pages_blocks_cloud_logos_company_logos
  pages_blocks_cloud_logos: typeof pages_blocks_cloud_logos
  pages_blocks_features_features: typeof pages_blocks_features_features
  pages_blocks_features: typeof pages_blocks_features
  pages_blocks_zigzag_content_links: typeof pages_blocks_zigzag_content_links
  pages_blocks_zigzag_content: typeof pages_blocks_zigzag_content
  pages_blocks_zigzag: typeof pages_blocks_zigzag
  pages_blocks_testimonial_reviews: typeof pages_blocks_testimonial_reviews
  pages_blocks_testimonial: typeof pages_blocks_testimonial
  pages_blocks_team_team_members: typeof pages_blocks_team_team_members
  pages_blocks_team: typeof pages_blocks_team
  pages: typeof pages
  pages_rels: typeof pages_rels
  _pages_v_version_hero_slider_images: typeof _pages_v_version_hero_slider_images
  ...
  _pages_v_blocks_cloud_logos_company_logos: typeof _pages_v_blocks_cloud_logos_company_logos
  _pages_v_blocks_cloud_logos: typeof _pages_v_blocks_cloud_logos
  ...
  _pages_v_blocks_zigzag_content_links: typeof _pages_v_blocks_zigzag_content_links
  _pages_v_blocks_zigzag_content: typeof _pages_v_blocks_zigzag_content
  _pages_v_blocks_zigzag: typeof _pages_v_blocks_zigzag
  _pages_v_blocks_testimonial_reviews: typeof _pages_v_blocks_testimonial_reviews
  _pages_v_blocks_testimonial: typeof _pages_v_blocks_testimonial
  _pages_v_blocks_team_team_members: typeof _pages_v_blocks_team_team_members
  ...
  footer_nav_sections_nav_items: typeof footer_nav_sections_nav_items
  footer_nav_sections: typeof footer_nav_sections
  footer: typeof footer
  footer_rels: typeof footer_rels
  relations_pages_hero_slider_images: typeof relations_pages_hero_slider_images
  ...
  relations_pages_blocks_cloud_logos_company_logos: typeof relations_pages_blocks_cloud_logos_company_logos
  relations_pages_blocks_cloud_logos: typeof relations_pages_blocks_cloud_logos
  ...
  relations_pages_blocks_zigzag_content_links: typeof relations_pages_blocks_zigzag_content_links
  relations_pages_blocks_zigzag_content: typeof relations_pages_blocks_zigzag_content
  relations_pages_blocks_zigzag: typeof relations_pages_blocks_zigzag
  relations_pages_blocks_testimonial_reviews: typeof relations_pages_blocks_testimonial_reviews
  relations_pages_blocks_testimonial: typeof relations_pages_blocks_testimonial
  relations_pages_blocks_team_team_members: typeof relations_pages_blocks_team_team_members
  relations_pages_blocks_team: typeof relations_pages_blocks_team
  relations_pages_rels: typeof relations_pages_rels
  relations_pages: typeof relations_pages
  relations__pages_v_version_hero_slider_images: typeof relations__pages_v_version_hero_slider_images
  ...
  relations__pages_v_blocks_cloud_logos_company_logos: typeof relations__pages_v_blocks_cloud_logos_company_logos
  relations__pages_v_blocks_cloud_logos: typeof relations__pages_v_blocks_cloud_logos
  ...
  relations__pages_v_blocks_zigzag_content_links: typeof relations__pages_v_blocks_zigzag_content_links
  relations__pages_v_blocks_zigzag_content: typeof relations__pages_v_blocks_zigzag_content
  relations__pages_v_blocks_zigzag: typeof relations__pages_v_blocks_zigzag
  relations__pages_v_blocks_testimonial_reviews: typeof relations__pages_v_blocks_testimonial_reviews
  relations__pages_v_blocks_testimonial: typeof relations__pages_v_blocks_testimonial
  relations__pages_v_blocks_team_team_members: typeof relations__pages_v_blocks_team_team_members
  ...
  relations_admins_roles: typeof relations_admins_roles
  ...
  relations_products_prices: typeof relations_products_prices
  ...
  relations_footer_nav_sections_nav_items: typeof relations_footer_nav_sections_nav_items
  relations_footer_nav_sections: typeof relations_footer_nav_sections
