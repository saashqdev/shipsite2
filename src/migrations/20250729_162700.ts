...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_accordion_size" AS ENUM('full', 'half', 'oneThird');
  CREATE TYPE "public"."enum_pages_blocks_features_layout" AS ENUM('standard', 'withImage');
  CREATE TYPE "public"."enum_pages_blocks_zigzag_content_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_zigzag_content_links_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum_pages_hero_type" AS ENUM('none', 'simpleImpact', 'simpleWithImage', 'sliderHero');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_accordion_size" AS ENUM('full', 'half', 'oneThird');
  CREATE TYPE "public"."enum__pages_v_blocks_features_layout" AS ENUM('standard', 'withImage');
  CREATE TYPE "public"."enum__pages_v_blocks_zigzag_content_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_zigzag_content_links_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum__pages_v_version_hero_type" AS ENUM('none', 'simpleImpact', 'simpleWithImage', 'sliderHero');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_admins_roles" AS ENUM('super-admin', 'admin');
  CREATE TYPE "public"."enum_redirects_to_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_forms_confirmation_type" AS ENUM('message', 'redirect');
  CREATE TYPE "public"."enum_forms_form_style" AS ENUM('newsletter', 'contact', 'none');
  CREATE TYPE "public"."enum_payload_jobs_log_task_slug" AS ENUM('inline', 'schedulePublish');
  CREATE TYPE "public"."enum_payload_jobs_log_state" AS ENUM('failed', 'succeeded');
  CREATE TYPE "public"."enum_payload_jobs_task_slug" AS ENUM('inline', 'schedulePublish');
  CREATE TYPE "public"."enum_header_nav_items_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_header_call_to_action_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_footer_nav_sections_nav_items_link_type" AS ENUM('reference', 'custom');
  CREATE TABLE "pages_hero_slider_images" (
  ...
  CREATE TABLE "pages_blocks_form_block" (
  	...
  	"intro_content" jsonb,
  	"secondary_content" boolean,
  	"secondary_content_text" jsonb,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_accordion" (
  	...
  	"title" varchar,
  	"description" varchar,
  	"size" "enum_pages_blocks_accordion_size" DEFAULT 'full',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_cloud_logos_company_logos" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"image_id" integer
  ...
  CREATE TABLE "pages_blocks_cloud_logos" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_features" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"layout" "enum_pages_blocks_features_layout" DEFAULT 'standard',
  	"header" varchar,
  	"title" varchar,
  	"description" varchar,
  	"image_id" integer,
  ...
  CREATE TABLE "pages_blocks_zigzag_content_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_pages_blocks_zigzag_content_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum_pages_blocks_zigzag_content_links_link_appearance" DEFAULT 'default'
  );
  
  CREATE TABLE "pages_blocks_zigzag_content" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"image_id" integer,
  ...
  CREATE TABLE "pages_blocks_zigzag" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_testimonial_reviews" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"first_name" varchar,
  ...
  CREATE TABLE "_pages_v_version_hero_slider_images" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"image_id" integer,
  ...
  CREATE TABLE "_pages_v_blocks_accordion" (
  	...
  	"title" varchar,
  	"description" varchar,
  	"size" "enum__pages_v_blocks_accordion_size" DEFAULT 'full',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_cloud_logos_company_logos" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"image_id" integer,
  ...
  CREATE TABLE "_pages_v_blocks_cloud_logos" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_features" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"layout" "enum__pages_v_blocks_features_layout" DEFAULT 'standard',
  	"header" varchar,
  	"title" varchar,
  	"description" varchar,
  	"image_id" integer,
  ...
  CREATE TABLE "_pages_v_blocks_zigzag_content_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"link_type" "enum__pages_v_blocks_zigzag_content_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum__pages_v_blocks_zigzag_content_links_link_appearance" DEFAULT 'default',
  	"_uuid" varchar
  );
  
  CREATE TABLE "_pages_v_blocks_zigzag_content" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"image_id" integer,
  ...
  CREATE TABLE "_pages_v_blocks_zigzag" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_testimonial_reviews" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"first_name" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_team_team_members" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"image_id" integer,
  ...
  CREATE TABLE "_pages_v" (
  	...
  	"version_hero_slider" boolean,
  	"version_hero_background_image_id" integer,
  	"version_hero_rich_text" jsonb,
  	"version_hero_show_top_text" boolean,
  	"version_hero_top_text" varchar,
  ...
  CREATE TABLE "products" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"stripe_product_i_d" varchar NOT NULL,
  	"name" varchar,
  	"description" varchar,
  	"metadata" jsonb,
  	"image" varchar,
  ...
  CREATE TABLE "forms" (
  	...
  	"form_style" "enum_forms_form_style" DEFAULT 'none' NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "header" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"show_c_t_a" boolean,
  	"call_to_action_link_type" "enum_header_call_to_action_link_type" DEFAULT 'reference',
  	"call_to_action_link_new_tab" boolean,
  	"call_to_action_link_url" varchar,
  	"call_to_action_link_label" varchar,
  	"styles_media_id" integer,
  ...
  CREATE TABLE "footer_nav_sections_nav_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_footer_nav_sections_nav_items_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar NOT NULL
  );
  ...
  CREATE TABLE "footer" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"logo_id" integer,
  	"use_bottom_text" boolean DEFAULT false,
  	"bottom_text" varchar,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  ALTER TABLE "pages_hero_slider_images" ADD CONSTRAINT "pages_hero_slider_images_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_hero_slider_images" ADD CONSTRAINT "pages_hero_slider_images_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_pricing_plans" ADD CONSTRAINT "pages_blocks_pricing_plans_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_cloud_logos_company_logos" ADD CONSTRAINT "pages_blocks_cloud_logos_company_logos_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_cloud_logos_company_logos" ADD CONSTRAINT "pages_blocks_cloud_logos_company_logos_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_cloud_logos"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_cloud_logos" ADD CONSTRAINT "pages_blocks_cloud_logos_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_zigzag_content_links" ADD CONSTRAINT "pages_blocks_zigzag_content_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_zigzag_content"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_zigzag_content" ADD CONSTRAINT "pages_blocks_zigzag_content_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_zigzag_content" ADD CONSTRAINT "pages_blocks_zigzag_content_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_zigzag"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_zigzag" ADD CONSTRAINT "pages_blocks_zigzag_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_testimonial_reviews" ADD CONSTRAINT "pages_blocks_testimonial_reviews_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_testimonial_reviews" ADD CONSTRAINT "pages_blocks_testimonial_reviews_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_testimonial"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_version_hero_slider_images" ADD CONSTRAINT "_pages_v_version_hero_slider_images_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_pages_v_version_hero_slider_images" ADD CONSTRAINT "_pages_v_version_hero_slider_images_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_pricing_plans" ADD CONSTRAINT "_pages_v_blocks_pricing_plans_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_cloud_logos_company_logos" ADD CONSTRAINT "_pages_v_blocks_cloud_logos_company_logos_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_cloud_logos_company_logos" ADD CONSTRAINT "_pages_v_blocks_cloud_logos_company_logos_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_cloud_logos"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_cloud_logos" ADD CONSTRAINT "_pages_v_blocks_cloud_logos_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_zigzag_content_links" ADD CONSTRAINT "_pages_v_blocks_zigzag_content_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_zigzag_content"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_zigzag_content" ADD CONSTRAINT "_pages_v_blocks_zigzag_content_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_zigzag_content" ADD CONSTRAINT "_pages_v_blocks_zigzag_content_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_zigzag"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_zigzag" ADD CONSTRAINT "_pages_v_blocks_zigzag_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_testimonial_reviews" ADD CONSTRAINT "_pages_v_blocks_testimonial_reviews_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_testimonial_reviews" ADD CONSTRAINT "_pages_v_blocks_testimonial_reviews_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_testimonial"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_team_team_members" ADD CONSTRAINT "_pages_v_blocks_team_team_members_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_team_team_members" ADD CONSTRAINT "_pages_v_blocks_team_team_members_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_team"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "header" ADD CONSTRAINT "header_styles_media_id_media_id_fk" FOREIGN KEY ("styles_media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "header_rels" ADD CONSTRAINT "header_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."header"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "header_rels" ADD CONSTRAINT "header_rels_pages_fk" FOREIGN KEY ("pages_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "header_rels" ADD CONSTRAINT "header_rels_posts_fk" FOREIGN KEY ("posts_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "footer_nav_sections_nav_items" ADD CONSTRAINT "footer_nav_sections_nav_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer_nav_sections"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "footer_nav_sections" ADD CONSTRAINT "footer_nav_sections_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "footer" ADD CONSTRAINT "footer_logo_id_media_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "footer_rels" ADD CONSTRAINT "footer_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."footer"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "footer_rels" ADD CONSTRAINT "footer_rels_pages_fk" FOREIGN KEY ("pages_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "footer_rels" ADD CONSTRAINT "footer_rels_posts_fk" FOREIGN KEY ("posts_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  CREATE INDEX "pages_hero_slider_images_order_idx" ON "pages_hero_slider_images" USING btree ("_order");
  CREATE INDEX "pages_hero_slider_images_parent_id_idx" ON "pages_hero_slider_images" USING btree ("_parent_id");
  CREATE INDEX "pages_hero_slider_images_image_idx" ON "pages_hero_slider_images" USING btree ("image_id");
  ...
  CREATE INDEX "pages_blocks_pricing_plans_product_idx" ON "pages_blocks_pricing_plans" USING btree ("product_id");
  ...
  CREATE INDEX "pages_blocks_cloud_logos_company_logos_order_idx" ON "pages_blocks_cloud_logos_company_logos" USING btree ("_order");
  CREATE INDEX "pages_blocks_cloud_logos_company_logos_parent_id_idx" ON "pages_blocks_cloud_logos_company_logos" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_cloud_logos_company_logos_image_idx" ON "pages_blocks_cloud_logos_company_logos" USING btree ("image_id");
  CREATE INDEX "pages_blocks_cloud_logos_order_idx" ON "pages_blocks_cloud_logos" USING btree ("_order");
  CREATE INDEX "pages_blocks_cloud_logos_parent_id_idx" ON "pages_blocks_cloud_logos" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_cloud_logos_path_idx" ON "pages_blocks_cloud_logos" USING btree ("_path");
  ...
  CREATE INDEX "pages_blocks_zigzag_content_links_order_idx" ON "pages_blocks_zigzag_content_links" USING btree ("_order");
  CREATE INDEX "pages_blocks_zigzag_content_links_parent_id_idx" ON "pages_blocks_zigzag_content_links" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_zigzag_content_order_idx" ON "pages_blocks_zigzag_content" USING btree ("_order");
  CREATE INDEX "pages_blocks_zigzag_content_parent_id_idx" ON "pages_blocks_zigzag_content" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_zigzag_content_image_idx" ON "pages_blocks_zigzag_content" USING btree ("image_id");
  CREATE INDEX "pages_blocks_zigzag_order_idx" ON "pages_blocks_zigzag" USING btree ("_order");
  CREATE INDEX "pages_blocks_zigzag_parent_id_idx" ON "pages_blocks_zigzag" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_zigzag_path_idx" ON "pages_blocks_zigzag" USING btree ("_path");
  CREATE INDEX "pages_blocks_testimonial_reviews_order_idx" ON "pages_blocks_testimonial_reviews" USING btree ("_order");
  CREATE INDEX "pages_blocks_testimonial_reviews_parent_id_idx" ON "pages_blocks_testimonial_reviews" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_testimonial_reviews_image_idx" ON "pages_blocks_testimonial_reviews" USING btree ("image_id");
  ...
  CREATE INDEX "_pages_v_version_hero_slider_images_order_idx" ON "_pages_v_version_hero_slider_images" USING btree ("_order");
  CREATE INDEX "_pages_v_version_hero_slider_images_parent_id_idx" ON "_pages_v_version_hero_slider_images" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_version_hero_slider_images_image_idx" ON "_pages_v_version_hero_slider_images" USING btree ("image_id");
  ...
  CREATE INDEX "_pages_v_blocks_pricing_plans_product_idx" ON "_pages_v_blocks_pricing_plans" USING btree ("product_id");
  ...
  CREATE INDEX "_pages_v_blocks_cloud_logos_company_logos_order_idx" ON "_pages_v_blocks_cloud_logos_company_logos" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_cloud_logos_company_logos_parent_id_idx" ON "_pages_v_blocks_cloud_logos_company_logos" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_cloud_logos_company_logos_image_idx" ON "_pages_v_blocks_cloud_logos_company_logos" USING btree ("image_id");
  CREATE INDEX "_pages_v_blocks_cloud_logos_order_idx" ON "_pages_v_blocks_cloud_logos" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_cloud_logos_parent_id_idx" ON "_pages_v_blocks_cloud_logos" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_cloud_logos_path_idx" ON "_pages_v_blocks_cloud_logos" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_blocks_zigzag_content_links_order_idx" ON "_pages_v_blocks_zigzag_content_links" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_zigzag_content_links_parent_id_idx" ON "_pages_v_blocks_zigzag_content_links" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_zigzag_content_order_idx" ON "_pages_v_blocks_zigzag_content" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_zigzag_content_parent_id_idx" ON "_pages_v_blocks_zigzag_content" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_zigzag_content_image_idx" ON "_pages_v_blocks_zigzag_content" USING btree ("image_id");
  CREATE INDEX "_pages_v_blocks_zigzag_order_idx" ON "_pages_v_blocks_zigzag" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_zigzag_parent_id_idx" ON "_pages_v_blocks_zigzag" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_zigzag_path_idx" ON "_pages_v_blocks_zigzag" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_testimonial_reviews_order_idx" ON "_pages_v_blocks_testimonial_reviews" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_testimonial_reviews_parent_id_idx" ON "_pages_v_blocks_testimonial_reviews" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_testimonial_reviews_image_idx" ON "_pages_v_blocks_testimonial_reviews" USING btree ("image_id");
  ...
  CREATE INDEX "_pages_v_blocks_team_team_members_order_idx" ON "_pages_v_blocks_team_team_members" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_team_team_members_parent_id_idx" ON "_pages_v_blocks_team_team_members" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_team_team_members_image_idx" ON "_pages_v_blocks_team_team_members" USING btree ("image_id");
  ...
  CREATE UNIQUE INDEX "products_stripe_product_i_d_idx" ON "products" USING btree ("stripe_product_i_d");
  ...
  CREATE INDEX "header_styles_styles_media_idx" ON "header" USING btree ("styles_media_id");
  CREATE INDEX "header_rels_order_idx" ON "header_rels" USING btree ("order");
  CREATE INDEX "header_rels_parent_idx" ON "header_rels" USING btree ("parent_id");
  CREATE INDEX "header_rels_path_idx" ON "header_rels" USING btree ("path");
  CREATE INDEX "header_rels_pages_id_idx" ON "header_rels" USING btree ("pages_id");
  CREATE INDEX "header_rels_posts_id_idx" ON "header_rels" USING btree ("posts_id");
  CREATE INDEX "footer_nav_sections_nav_items_order_idx" ON "footer_nav_sections_nav_items" USING btree ("_order");
  CREATE INDEX "footer_nav_sections_nav_items_parent_id_idx" ON "footer_nav_sections_nav_items" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   DROP TABLE "pages_hero_slider_images" CASCADE;
  ...
  DROP TABLE "pages_blocks_cloud_logos_company_logos" CASCADE;
  DROP TABLE "pages_blocks_cloud_logos" CASCADE;
  DROP TABLE "pages_blocks_features_features" CASCADE;
  DROP TABLE "pages_blocks_features" CASCADE;
  DROP TABLE "pages_blocks_zigzag_content_links" CASCADE;
  DROP TABLE "pages_blocks_zigzag_content" CASCADE;
  DROP TABLE "pages_blocks_zigzag" CASCADE;
  DROP TABLE "pages_blocks_testimonial_reviews" CASCADE;
  ...
  DROP TABLE "_pages_v_version_hero_slider_images" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_cloud_logos_company_logos" CASCADE;
  DROP TABLE "_pages_v_blocks_cloud_logos" CASCADE;
  DROP TABLE "_pages_v_blocks_features_features" CASCADE;
  DROP TABLE "_pages_v_blocks_features" CASCADE;
  DROP TABLE "_pages_v_blocks_zigzag_content_links" CASCADE;
  DROP TABLE "_pages_v_blocks_zigzag_content" CASCADE;
  DROP TABLE "_pages_v_blocks_zigzag" CASCADE;
  DROP TABLE "_pages_v_blocks_testimonial_reviews" CASCADE;
  DROP TABLE "_pages_v_blocks_testimonial" CASCADE;
  DROP TABLE "_pages_v_blocks_team_team_members" CASCADE;
  ...
  DROP TABLE "footer_nav_sections_nav_items" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_accordion_size";
  DROP TYPE "public"."enum_pages_blocks_features_layout";
  DROP TYPE "public"."enum_pages_blocks_zigzag_content_links_link_type";
  DROP TYPE "public"."enum_pages_blocks_zigzag_content_links_link_appearance";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_accordion_size";
  DROP TYPE "public"."enum__pages_v_blocks_features_layout";
  DROP TYPE "public"."enum__pages_v_blocks_zigzag_content_links_link_type";
  DROP TYPE "public"."enum__pages_v_blocks_zigzag_content_links_link_appearance";
  ...
  DROP TYPE "public"."enum_forms_form_style";
  DROP TYPE "public"."enum_payload_jobs_log_task_slug";
  DROP TYPE "public"."enum_payload_jobs_log_state";
  DROP TYPE "public"."enum_payload_jobs_task_slug";
  DROP TYPE "public"."enum_header_nav_items_link_type";
  DROP TYPE "public"."enum_header_call_to_action_link_type";
  DROP TYPE "public"."enum_footer_nav_sections_nav_items_link_type";`)
}
